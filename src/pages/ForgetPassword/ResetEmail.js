...
const ResetEmail = () => {
  return (
    <div className=''>
      ...
      <div className='text-gray-400 mt-6'>We have sent instructions on how to reset your password to your Mail. Please follow the instructions from the email.</div> 
    </div>
    </div>
  )
}
